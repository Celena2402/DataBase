-- Домашнее задание
DROP SCHEMA IF EXISTS sem4_DZ;
CREATE SCHEMA IF NOT EXISTS sem4_DZ;
...
SELECT *
FROM shops
INNER JOIN cats -- INNER JOIN  и JOIN одно и то же
...
from shops
where not exists (select * from cats
where shops.id = cats.shops_id and cats.name in ("Murzik","Zuza"));

-- 4.Вывести название и цену для всех анализов, которые продавались 5 февраля 2020 и всю следующую неделю.

select 
orders.ord_datetime as 'Дата анализа', 
groupsan.gr_name as 'Название группы',
analysis.an_name as 'Название анализа', 
analysis.an_cost as 'Цена_себестоимость', 
analysis.an_price as 'Цена_розничная'
from analysis, groupsan
inner join orders
where 
orders.ord_an=analysis.an_id and groupsan.gr_id=analysis.an_group 
and ord_datetime>='2020-02-05' and ord_datetime<'2020-02-12'
